        ...
        <div className="glass-card p-8 rounded-3xl border border-white/50 dark:border-slate-800/80 shadow-2xl bg-white/40 dark:bg-[#0f1422]/60 backdrop-blur-xl">
          ...
          <div className="text-center mb-8 space-y-2">
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400">
              Sign in to translate slang and access your developer dashboard
            </p>
          </div>
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between text-xs sm:text-sm">
              <label className="flex items-center space-x-2 cursor-pointer">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded text-brand-500 border-slate-200 dark:border-slate-800 focus:ring-brand-500"
                />
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs uppercase"><span className="bg-white/40 dark:bg-[#0f1422] px-3 text-slate-400">Or continue with</span></div>
          </div>

          {/* Social Logins */}
          <div className="grid grid-cols-2 gap-3">
            <button
              onClick={() => alert("SSO integration is a demo mockup. Please register with a standard email.")}
